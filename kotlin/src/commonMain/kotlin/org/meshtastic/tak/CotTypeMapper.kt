...
public object CotTypeMapper {
     ...
     */
    public fun typeToEnum(cotTypeString: String): Int = stringToType[cotTypeString] ?: COTTYPE_OTHER
     ...
     */
    public fun howToEnum(howString: String): Int = stringToHow[howString] ?: COTHOW_UNSPECIFIED
