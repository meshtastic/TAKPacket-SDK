...
| Metric | Value |
|--------|-------|
| Total test messages | 46 |
| 100% under 237B | YES |
| Median compressed size | 124B |
| Median compression ratio | 5.3x |
| Worst case | 217B (91% of LoRa MTU) |
...
| alert_tic | b-a-o-opn | 407B | 109B | 120B | 3.4x | non-aircraft |
...
| drawing_ellipse | u-d-c-e | 646B | 77B | 88B | 7.3x | non-aircraft |
...
| drawing_rectangle_itak | u-d-r | 754B | 147B | 144B | 5.2x | non-aircraft |
| drawing_telestration | u-d-f-m | 2130B | 356B | 215B | 9.9x | non-aircraft |
| emergency_911 | b-a-o-tbl | 477B | 85B | 87B | 5.5x | non-aircraft |
| emergency_cancel | b-a-o-can | 538B | 100B | 94B | 5.7x | non-aircraft |
| geochat_broadcast | b-t-f | 896B | 101B | 101B | 8.9x | non-aircraft |
| geochat_dm | b-t-f | 960B | 141B | 98B | 9.8x | non-aircraft |
| geochat_simple | b-t-f | 836B | 128B | 124B | 6.7x | non-aircraft |
| marker_2525 | a-u-G | 714B | 163B | 125B | 5.7x | non-aircraft |
| marker_goto | b-m-p-w-GOTO | 560B | 98B | 93B | 6.0x | non-aircraft |
| marker_goto_itak | b-m-p-w-GOTO | 616B | 192B | 170B | 3.6x | non-aircraft |
| marker_icon_set | a-u-G | 736B | 185B | 160B | 4.6x | non-aircraft |
| marker_spot | b-m-p-s-m | 723B | 164B | 144B | 5.0x | non-aircraft |
| marker_tank | a-h-G-E-V-A-T | 700B | 137B | 113B | 6.2x | non-aircraft |
| pli_basic | a-f-G-U-C | 446B | 52B | 58B | 7.7x | non-aircraft |
| pli_full | a-f-G-U-C | 754B | 180B | 132B | 5.7x | non-aircraft |
| pli_itak | a-f-G-U-C | 533B | 83B | 97B | 5.5x | non-aircraft |
| pli_stationary | a-f-G-U-C | 619B | 139B | 136B | 4.6x | non-aircraft |
| pli_takaware | a-f-G-U-C | 539B | 100B | 106B | 5.1x | non-aircraft |
| pli_webtak | a-f-G-U-C-I | 668B | 128B | 138B | 4.8x | non-aircraft |
...
| ranging_circle | u-r-b-c-c | 672B | 109B | 94B | 7.1x | non-aircraft |
...
marker_tank           113B |#######################
waypoint              116B |########################
drawing_circle_large  119B |#########################
taktalk_room_data     119B |#########################
alert_tic             120B |#########################
geochat_simple        124B |##########################
marker_2525           125B |##########################
